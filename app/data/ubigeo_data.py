UBIGEO_PERU = {
    ...
    "AYACUCHO": {
        ...
        "HUANTA": ["HUANTA", "AYAHUANCO", "HUAMANGUILLA", "IGUAIN", "LURICOCHA", "SANTILLANA", "SIVIA", "LLOCHEGUA", "CANAYRE", "UCHURACCAY", "PUCACOLPA"],
    ...
    "CUSCO": {
        ...
        "LA CONVENCION": ["SANTA ANA", "ECHARATE", "HUAYOPATA", "MARANURA", "OCOBAMBA", "QUELLOUNO", "QUIMBIRI", "SANTA TERESA", "VILCABAMBA", "PICHARI", "INKAWASI", "VILLA VIRGEN", "VILLA KINTIARINA", "MEGANTONI"],
    ...
    "HUANCAVELICA": {
        ...
        "CASTROVIRREYNA": ["CASTROVIRREYNA", "ARMA", "AURAHUA", "CAPILLAS", "CHUPAMARCA", "COCAS", "HUAMATAMBO", "MOLLEPAMPA", "SAN JUAN", "SANTA ANA", "TANTARA", "TICRAPO", "WINCHOS"],
        ...
        "TAYACAJA": ["PAMPAS", "ACOSTAMBO", "ACRAQUIA", "AHUAYCHA", "COLCABAMBA", "DANIEL HERNANDEZ", "HUACHOCOLPA", "HUARIBAMBA", "ÑAHUIMPUQUIO", "PAZOS", "QUISHUAR", "SALCABAMBA", "SALCAHUASI", "SAN MARCOS DE ROCCHAC", "SURCUBAMBA", "TINTAY PUNCU", "PICHOS", "SANTIAGO DE TUCUMA"]
    },
    "HUANUCO": {
        "HUANUCO": ["HUANUCO", "AMARILIS", "CHINCHAO", "CHURUBAMBA", "MARGOS", "QUISQUI", "SAN FRANCISCO DE CAYRAN", "SAN PEDRO DE CHAULAN", "SANTA MARIA DEL VALLE", "YARUMAYO", "PILLCO MARCA", "YACUS"],
    ...
    "LIMA": {
        ...
        "YAUYOS": ["YAUYOS", "ALIS", "AYAUCA", "AYAVIRI", "AZANGARO", "CACRA", "CARANIA", "CATAHUASI", "CHOCOS", "COCHAS", "COLONIA", "HONGOS", "HUAMPARA", "HUANCAYA", "HUANGASCAR", "HUANTAN", "HUAÑEC", "LARAOS", "LINCHA", "MADEAN", "MIRAFLORES", "OMAS", "PUTINZA", "QUINOCAY", "SAN JOAQUIN", "SAN PEDRO DE PILAS", "TANTA", "TAURIPAMPA", "OMAS", "TUPE", "VIÑAC", "VITIS"]
    },
    "LORETO": {
