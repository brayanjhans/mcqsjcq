                ...
                {loading ? (
                    viewMode === 'card' ? (
                        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-8">
                            {[...Array(8)].map((_, i) => (
                                <div key={i} className="rounded-[2.5rem] bg-white border border-slate-100 shadow-md p-8 space-y-6 overflow-hidden relative">
                        ...
                        /* Table skeleton */
                        <div className="w-full overflow-x-auto rounded-[2rem] border border-slate-200 shadow-xl bg-white">
                            <div className="h-14 bg-gradient-to-r from-[#1e3a8a] to-[#172554] rounded-t-[2rem]"></div>
                            <div className="divide-y divide-slate-100">
                                {[...Array(8)].map((_, i) => (
                                    <div key={i} className="flex items-center gap-4 px-6 py-5">
                                        <div className="w-8 h-4 skeleton-box rounded shrink-0"></div>
                                        <div className="flex-1 h-4 skeleton-box rounded"></div>
                                        <div className="w-24 h-4 skeleton-box rounded"></div>
                                        <div className="w-32 h-4 skeleton-box rounded"></div>
                                        <div className="w-20 h-4 skeleton-box rounded"></div>
                                        <div className="w-24 h-4 skeleton-box rounded"></div>
                                        <div className="w-10 h-8 skeleton-box rounded-xl shrink-0"></div>
                                    </div>
                                ))}
                            </div>
                        </div>
