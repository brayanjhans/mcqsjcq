...
cur = conn.cursor()
# Update Cabecera
cur.execute("UPDATE licitaciones_cabecera SET estado_proceso='ADJUDICADO' WHERE id_convocatoria='1193323'")
...
cur.execute(adj_sql, ('1193323-1774945', '1193323', 'CONSORCIO 4 CAT', '1774945', 667202.51, 'PEN'))
conn.commit()
conn.close()
print('VPS UPDATED for 1193323')
'''
